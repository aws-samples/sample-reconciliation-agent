...
backend/                Python 3.12 Lambda handlers
  recon_core/           Shared domain: schema, cases, status, confidence, auto_resolve,
                        lessons_recall, errors, skills_s3, otel_client, prompt_source, session (the one owner of AgentCore session-id derivation)
...
infra/
  modules/              Terraform modules: foundation, notice-store, contact-store,
                        ...
                        observability, microsoft-graph-obo, tier2-dispatch
