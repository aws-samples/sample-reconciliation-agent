...
vi.mock("@/components/SuggestedQuestions", () => ({
  SuggestedQuestions: () => (
    <div data-testid="suggested-questions">Questions</div>
  ),
}));
...
vi.mock("@/components/BrowserResultModal", () => ({
  BrowserResultModal: () => (
    <div data-testid="browser-result-modal">Browser Result</div>
  ),
}));

vi.mock("@/components/InterruptApprovalModal", () => ({
  InterruptApprovalModal: () => (
    <div data-testid="interrupt-modal">Interrupt Modal</div>
  ),
}));
...
describe("ChatInterface", () => {
      ...
      mockUseChat.groupedMessages = [
        {
          ...
          id: "user_1",
          messages: [
            { id: "1", text: "Hello", sender: "user", timestamp: "12:00" },
          ],
        },
      ];
      ...
      mockUseChat.groupedMessages = [
        {
          ...
          id: "turn_1",
          messages: [
            { id: "2", text: "Hi there!", sender: "bot", timestamp: "12:01" },
          ],
        },
      ];
  ...
  describe("Interrupt Handling", () => {
        ...
        interrupts: [
          {
            ...
            reason: { query: "test", intent: "delete emails" },
          },
        ],
      };
    ...
    it("should not show interrupt modal for research-approval interrupts", () => {
      mockUseChat.currentInterrupt = {
        interrupts: [
          { id: "int1", name: "chatbot-research-approval", reason: {} },
        ],
      };
