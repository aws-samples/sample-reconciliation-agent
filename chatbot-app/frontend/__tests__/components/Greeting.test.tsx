...
describe("Greeting Component", () => {
  ...
  it("should have proper styling classes", () => {
    ...
    const greetingElement = screen.getByText("What can I help you with?");
...
describe("PromptSuggestions Component", () => {
  ...
  it("should show prompts panel when category is clicked", () => {
    ...
    expect(
      screen.getByText(
        "Search the web for the latest AI news and summarize key highlights",
      ),
    ).toBeInTheDocument();
  });
  ...
  it("should call onSelectPrompt when a prompt is clicked", () => {
    ...
    fireEvent.click(
      screen.getByText("Build a To-Do web app with React and Tailwind CSS"),
    );
    expect(onSelectPrompt).toHaveBeenCalledWith(
      "Build a To-Do web app with React and Tailwind CSS",
    );
  });
});
