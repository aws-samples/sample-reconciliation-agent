  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 pb-2 flex-shrink-0">
        <h2 className="text-[14px] font-semibold text-sidebar-foreground">
          Connectors
        </h2>
        <p className="text-[11px] text-sidebar-foreground/40 mt-0.5 leading-relaxed">
          Skills are loaded on demand — no need to select upfront. Disable any
          you don't want the agent to use.
        </p>
      </div>
                ...
                <div className="space-y-0.5">
                  {skills.map((skill) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`w-5 h-5 flex items-center justify-center flex-shrink-0 ${enabled ? "" : "opacity-30"}`}
                        >
                          <SkillIcon
                        ...
                        <span
                          className={`text-[13px] flex-1 min-w-0 truncate ${enabled ? "text-sidebar-foreground" : "text-sidebar-foreground/35"}`}
                        >
                          {skill.name
                            .split("-")
