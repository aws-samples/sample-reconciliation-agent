...
export interface DataTableColumn<T> {
  id: string;
  /** Usually a label. A node so a column can carry a control — a select-all checkbox, say. */
...
/** The columns as shipped, in shipped order — the baseline a stored layout is reconciled against. */
...
export function DataTable<T>({
   ...
   *
   * A header can be a control rather than a label (a select-all box lives in one), so a
